/*you win the fight by either being drunk or buzzkilling the enemy. Buzzkilling only works if you're sober, and it doesn't work on animals.*/
    ...
    function promptHandler(stage, player, enemy, weaponNum, turn){
        ...
        switch(stage) {
            case 1:
                var promptText = 'In the drunken land of Tamriel stands one hero. This bladesman is a mildly-attractive nord, a bladesman of the meadery, whose mission is to get drunk enough to defeat evil for all of Tamriel! One foretold soul to earn the glory of victory! (Note: Alcohol is good for you in this game, it will make you more charismatic and a better fighter.)'
